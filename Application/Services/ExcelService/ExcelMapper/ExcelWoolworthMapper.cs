...
{
    public static class ExcelWoolworthMapper
    {
        #region WET
        ...
        public static string[] MapBurstingStrength()
        {
            return new string[]
            {
                "A9","A10","A11"
        ...
        public static string[] MapTearStrength()
        {
            return new string[]
            {
                "A11","A13","A15"
        ...
        public static string[] MapTensileStrength()
        {
            return new string[]
            {
                "A11","A13"
        ...
        public static string[] MapSeamStrength(string SampleDescription)
        {
