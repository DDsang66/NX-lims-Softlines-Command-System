...
namespace NX_lims_Softlines_Command_System.Application.Services
{
    public class CrazyLineBuyer : IBuyer
    {
        private readonly CrazyLineService _service;

        public CrazyLineBuyer(CrazyLineService service)
        {
            _service = service;
        }
