...
{
    public class PepcoService : IBuyerService
    {
        private readonly PepcoRepository _repo;
        private readonly FiberContentHelper _helper;

        public PepcoService(PepcoRepository repo, FiberContentHelper helper)
        {
            _repo = repo;
            _helper = helper;
        }
        ...
        public async Task<object?> ShowParameterAsync([FromBody] RequiredInfoDto infoDto)
        {
            ...
            PepcoParameterProvider helper = new PepcoParameterProvider(_helper);
            // 生成对应 DTO
            try
            {
        ...
        private static ParamDto CreateResponse(string itemName, WetParameterIso p, string Param) => itemName switch
        {
            ...
            "Appearance" => new(p.ContactItem!, p.ReportNumber, p.Temperature + "°C", null, null, p.Ballast, p.SpecialCareInstruction, p.DryProcedure, p.WashingProcedure, null, null, null, null),
            ...
            "Absorbency" => new(itemName, null, null, null, null, null, null, null, null, null, null, null, Param),
            "Wicking" => new(itemName, null, null, null, null, null, null, null, null, null, null, null, Param),
