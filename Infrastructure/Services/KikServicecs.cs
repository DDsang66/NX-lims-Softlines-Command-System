...
{
    public class KikService : IBuyerService
    {
        private readonly KikRepository _repo;
        private readonly FiberContentHelper _helper;

        public KikService(KikRepository repo, FiberContentHelper helper)
        {
            _repo = repo;
            _helper = helper;
        }
        ...
        public async Task<object?> ShowParameterAsync([FromBody] RequiredInfoDto infoDto)
        {
            ...
            KikParameterProvider helper = new KikParameterProvider(_helper);
            // 生成对应 DTO
            try
            {
        ...
        private static ParamDto CreateResponse(string itemName, WetParameterIso p, string Param) => itemName switch
        {
            ...
            "Spirality/Skewing" => new(p.ContactItem!, p.ReportNumber, p.Temperature + "°F", null, null, p.Ballast, p.SpecialCareInstruction, p.DryProcedure, p.WashingProcedure, null, null, null, null),
