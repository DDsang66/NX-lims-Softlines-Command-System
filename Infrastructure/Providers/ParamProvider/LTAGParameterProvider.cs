...
namespace NX_lims_Softlines_Command_System.Infrastructure.Providers.ParamProvider
{
    public class LTAGParameterProvider
    {
        ...
        {
            ("CF to Washing", "4N" or "4M" or "4G" or "3N", _) => new WetParameterAatcc
            {
            ...
            ("CF to Washing", "4H" or "3M" or "3G" or "3H", _) => new WetParameterAatcc
            {
                ContactItem = p.ItemName,
                ReportNumber = p.OrderNumber!,
                Standard = p.Standard,
            ...
            ("Water Resistance-Hydrostatic Pressure", _, _) => new WetParameterAatcc
            {
                ContactItem = p.ItemName,
                ReportNumber = p.OrderNumber!,
                Standard = p.Standard,
