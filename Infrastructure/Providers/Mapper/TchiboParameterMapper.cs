...
namespace NX_lims_Softlines_Command_System.Infrastructure.Providers.Mapper
{
    public class TchiboParameterMapper
    {
        ...
        {
            ["CF to Washing"] = (p,param) => new(p.ContactItem!, p.Standard, p.Temperature + "°C", p.Program, p.SteelBallNum, null, null, null, p.WashingProcedure, null, null, null, p.Iron),
            ["DS to Washing"] = (p, param) => new(p.ContactItem!, p.Standard, p.Temperature + "°C", null, null, p.Ballast, p.SpecialCareInstruction, p.DryProcedure, p.WashingProcedure, null, p.Program, p.AfterWash, p.Detergent),
            ...
            ["Absorbency"] = (p, param) => new(p.ContactItem!, p.Standard, p.Temperature + "°C", p.Program, null, p.Ballast, p.SpecialCareInstruction, p.DryProcedure, p.WashingProcedure, null, null, p.AfterWash, null),
            ...
            ["CF to Hot Pressing"] = (p, param) => new(p.ContactItem!, p.Standard, p.Temperature + "°C", null, null, null, null, null, null, null, null, null,p.Iron),
            ["CF to Saliva"] = (p, param) => new(p.ContactItem!, p.Standard, null, null, null, null, null, null, null, null, null, null, param),
            ["CF to Sweat"] = (p, param) => new(p.ContactItem!, p.Standard, null, null, null, null, null, null, null, null, null, null, param),
            ...
            ["Appearance"] = (p, param) => new(p.ContactItem!, p.Standard, null, null, null, null, null, null, null, null, null, null, param)
        };
