...
namespace NX_lims_Softlines_Command_System.Infrastructure.Providers.Mapper
{
    public class PepcoParameterMapper
    {
        private static readonly Dictionary<string, Func<WetParameterIso, string, ParamDto>> Mappings = new()
        {
            ...
            ["DS to Washing"] = (p, param) => new(p.ContactItem!, p.ReportNumber, p.Temperature + "°C", null, null, p.Ballast, p.SpecialCareInstruction, p.DryProcedure, p.WashingProcedure, null, null, null, null),
            ["Appearance"] = (p, param) => new(p.ContactItem!, p.ReportNumber, p.Temperature + "°C", null, null, p.Ballast, p.SpecialCareInstruction, p.DryProcedure, p.WashingProcedure, null, null, null, null),
            ...
            ["Absorbency"]= (p, param) => new(p.ContactItem!, null, null, null, null, null, null, null, null, null, null, null, param),
            ["Wicking"] = (p, param) => new(p.ContactItem!, null, null, null, null, null, null, null, null, null, null, null, param),
