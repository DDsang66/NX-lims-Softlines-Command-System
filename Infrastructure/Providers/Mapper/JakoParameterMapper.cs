...
namespace NX_lims_Softlines_Command_System.Infrastructure.Providers.Mapper
{
    public class JakoParameterMapper
    {
        ...
        {
            ["CF to Washing"] = (p, param) => new(p.ContactItem!, p.ReportNumber, p.Temperature + "°C", p.Program, p.SteelBallNum, null, null, null, null, null, null, null, null),
            ["CF to Hot Pressing"] = (p, param) => new(p.ContactItem!, p.ReportNumber, p.Temperature + "°C", null, null, null, null, null, null, null, null, null, null),
            ["Appearance"] = (p, param) => new(p.ContactItem!, p.ReportNumber, p.Temperature + "°C", p.Program, null, p.Ballast, p.SpecialCareInstruction, p.DryProcedure, p.WashingProcedure, null, null, p.AfterWash, p.Iron),
            ...
            ["Print Durability For JAKO"] = (p, param) => new(p.ContactItem!, p.ReportNumber, p.Temperature + "°C", p.Program, null, null, null, p.DryProcedure, null, null, null, null, null),
            ["Heat Press Test For JAKO"] = (p, param) => new(p.ContactItem!, p.ReportNumber, p.Temperature + "°C", p.Program, null, null, null, null, null, null, null, null, null),
            ...
            ["Seam Strength"] = (p, param) => new(p.ContactItem!, null, null, null, null, null, null, null, null, null, null, null, param),
            ["Bursting Strength"] = (p, param) => new(p.ContactItem!, null, null, null, null, null, null, null, null, null, null, null, param),
            ["Tensile Strength"] = (p, param) => new(p.ContactItem!, null, null, null, null, null, null, null, null, null, null, null, param),
            ...
            ["Water Repellency-Spray Test"] = (p, param) => new(p.ContactItem!, null, null, null, null, null, null, null, null, null, null, null, param),
            ["Spirality/Skewing"] = (p, param) => new(p.ContactItem!, null, null, null, null, null, null, null, null, null, null, null, param),
